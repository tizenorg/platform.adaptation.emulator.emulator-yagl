...
static __inline void yagl_transport_put_out_GLclampx(struct yagl_transport *t,
                                                     GLclampx value)
{
    yagl_transport_put_out_uint32_t(t, value);
}

static __inline void yagl_transport_put_out_GLfixed(struct yagl_transport *t,
                                                    GLfixed value)
{
    yagl_transport_put_out_uint32_t(t, value);
}
...
static __inline void yagl_transport_put_in_GLfixed(struct yagl_transport *t,
                                                   GLfixed *value)
{
    yagl_transport_put_in_uint32_t(t, (uint32_t*)value);
}
