...
YAGL_PIXEL_FORMAT_DECL(gles, GL_ALPHA, GL_ALPHA, GL_UNSIGNED_BYTE);
YAGL_PIXEL_FORMAT_DECL(gles, GL_ALPHA, GL_ALPHA, GL_FLOAT);
YAGL_PIXEL_FORMAT_DECL(gles, GL_ALPHA, GL_ALPHA, GL_HALF_FLOAT);
YAGL_PIXEL_FORMAT_DECL(gles, GL_ALPHA, GL_ALPHA, GL_HALF_FLOAT_OES);
...
YAGL_PIXEL_FORMAT_DECL(gles, GL_LUMINANCE, GL_LUMINANCE, GL_UNSIGNED_BYTE);
YAGL_PIXEL_FORMAT_DECL(gles, GL_LUMINANCE, GL_LUMINANCE, GL_FLOAT);
YAGL_PIXEL_FORMAT_DECL(gles, GL_LUMINANCE, GL_LUMINANCE, GL_HALF_FLOAT);
YAGL_PIXEL_FORMAT_DECL(gles, GL_LUMINANCE, GL_LUMINANCE, GL_HALF_FLOAT_OES);
YAGL_PIXEL_FORMAT_DECL(gles, GL_LUMINANCE_ALPHA, GL_LUMINANCE_ALPHA, GL_UNSIGNED_BYTE);
YAGL_PIXEL_FORMAT_DECL(gles, GL_LUMINANCE_ALPHA, GL_LUMINANCE_ALPHA, GL_FLOAT);
YAGL_PIXEL_FORMAT_DECL(gles, GL_LUMINANCE_ALPHA, GL_LUMINANCE_ALPHA, GL_HALF_FLOAT);
YAGL_PIXEL_FORMAT_DECL(gles, GL_LUMINANCE_ALPHA, GL_LUMINANCE_ALPHA, GL_HALF_FLOAT_OES);
