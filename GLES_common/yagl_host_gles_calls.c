...
void yagl_host_glFramebufferTexture3D(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level, GLint zoffset)
{
    ...
    yagl_transport_begin(t, yagl_api_id_gles, 66, 6 * 8, 6 * 8);
    yagl_transport_put_out_GLenum(t, target);
    yagl_transport_put_out_GLenum(t, attachment);
    yagl_transport_put_out_GLenum(t, textarget);
    yagl_transport_put_out_GLuint(t, texture);
...
void yagl_host_glFramebufferTextureLayer(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint layer)
{
    ...
    yagl_transport_begin(t, yagl_api_id_gles, 67, 5 * 8, 5 * 8);
    yagl_transport_put_out_GLenum(t, target);
    yagl_transport_put_out_GLenum(t, attachment);
    yagl_transport_put_out_GLuint(t, texture);
    yagl_transport_put_out_GLint(t, level);
...
void yagl_host_glGenRenderbuffers(const GLuint *renderbuffers, int32_t renderbuffers_count)
{
    ...
    yagl_transport_begin(t, yagl_api_id_gles, 68, 2 * 8, 0 * 8 + yagl_transport_array_size(renderbuffers, renderbuffers_count, sizeof(GLuint)));
...
/*
 * glRenderbufferStorageMultisample wrapper. id = 72
 */
void yagl_host_glRenderbufferStorageMultisample(GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height)
{
    ...
    yagl_transport_begin(t, yagl_api_id_gles, 72, 5 * 8, 5 * 8);
    yagl_transport_put_out_GLenum(t, target);
...
/*
 * glShaderSource wrapper. id = 75
 */
void yagl_host_glShaderSource(GLuint shader, const GLchar *string, int32_t string_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 75, 3 * 8, 1 * 8 + yagl_transport_array_size(string, string_count, sizeof(GLchar)));
    yagl_transport_put_out_GLuint(t, shader);
...
/*
 * glCompileShader wrapper. id = 78
 */
void yagl_host_glCompileShader(GLuint shader)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 78, 1 * 8, 1 * 8);
    yagl_transport_put_out_GLuint(t, shader);
    yagl_transport_end(t);
}
...
void yagl_host_glBindAttribLocation(GLuint program, GLuint index, const GLchar *name, int32_t name_count)
{
    ...
    yagl_transport_begin(t, yagl_api_id_gles, 79, 4 * 8, 2 * 8 + yagl_transport_array_size(name, name_count, sizeof(GLchar)));
    yagl_transport_put_out_GLuint(t, program);
    yagl_transport_put_out_GLuint(t, index);
...
/*
 * glGetActiveAttrib wrapper. id = 80
 */
void yagl_host_glGetActiveAttrib(GLuint program, GLuint index, GLint *size, GLenum *type, GLchar *name, int32_t name_maxcount, int32_t *name_count)
{
    ...
    yagl_transport_begin(t, yagl_api_id_gles, 80, 8 * 8, 6 * 8 + yagl_transport_array_size(name, name_maxcount, sizeof(GLchar)));
    yagl_transport_put_out_GLuint(t, program);
    yagl_transport_put_out_GLuint(t, index);
...
/*
 * glGetActiveUniform wrapper. id = 81
 */
...
/*
 * glGetAttribLocation wrapper. id = 82
 */
int yagl_host_glGetAttribLocation(GLuint program, const GLchar *name, int32_t name_count)
{
    ...
    yagl_transport_begin(t, yagl_api_id_gles, 82, 5 * 8, 3 * 8 + yagl_transport_array_size(name, name_count, sizeof(GLchar)));
    yagl_transport_put_out_GLuint(t, program);
    yagl_transport_put_out_array(t, name, name_count, sizeof(GLchar));
...
/*
 * glGetProgramInfoLog wrapper. id = 84
 */
...
/*
 * glGetShaderiv wrapper. id = 85
 */
void yagl_host_glGetShaderiv(GLuint shader, GLenum pname, GLint *param)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 85, 4 * 8, 4 * 8);
    yagl_transport_put_out_GLuint(t, shader);
    yagl_transport_put_out_GLenum(t, pname);
    yagl_transport_put_in_GLint(t, param);
    yagl_transport_end(t);
...
/*
 * glGetShaderInfoLog wrapper. id = 86
 */
GLboolean yagl_host_glGetShaderInfoLog(GLuint shader, GLchar *infolog, int32_t infolog_maxcount, int32_t *infolog_count)
{
    ...
    yagl_transport_begin(t, yagl_api_id_gles, 86, 5 * 8, 3 * 8 + yagl_transport_array_size(infolog, infolog_maxcount, sizeof(GLchar)));
    yagl_transport_put_out_GLuint(t, shader);
    yagl_transport_put_in_array(t, infolog, infolog_maxcount, infolog_count, sizeof(GLchar));
    yagl_transport_put_in_GLboolean(t, &retval);
    yagl_transport_end(t);
...
void yagl_host_glGetUniformfv(GLboolean tl, GLuint program, uint32_t location, GLfloat *params, int32_t params_maxcount, int32_t *params_count)
{
    ...
    yagl_transport_begin(t, yagl_api_id_gles, 87, 5 * 8, 3 * 8 + yagl_transport_array_size(params, params_maxcount, sizeof(GLfloat)));
...
void yagl_host_glGetUniformiv(GLboolean tl, GLuint program, uint32_t location, GLint *params, int32_t params_maxcount, int32_t *params_count)
{
    ...
    yagl_transport_begin(t, yagl_api_id_gles, 88, 5 * 8, 3 * 8 + yagl_transport_array_size(params, params_maxcount, sizeof(GLint)));
    yagl_transport_put_out_GLboolean(t, tl);
    yagl_transport_put_out_GLuint(t, program);
    yagl_transport_put_out_uint32_t(t, location);
    yagl_transport_put_in_array(t, params, params_maxcount, params_count, sizeof(GLint));
...
/*
 * glGetUniformLocation wrapper. id = 89
 */
...
/*
 * glGetVertexAttribfv wrapper. id = 90
 */
void yagl_host_glGetVertexAttribfv(GLuint index, GLenum pname, GLfloat *params, int32_t params_maxcount, int32_t *params_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 90, 4 * 8, 2 * 8 + yagl_transport_array_size(params, params_maxcount, sizeof(GLfloat)));
    yagl_transport_put_out_GLuint(t, index);
    yagl_transport_put_out_GLenum(t, pname);
    yagl_transport_put_in_array(t, params, params_maxcount, params_count, sizeof(GLfloat));
    yagl_transport_end(t);
...
/*
 * glGetVertexAttribiv wrapper. id = 91
 */
void yagl_host_glGetVertexAttribiv(GLuint index, GLenum pname, GLint *params, int32_t params_maxcount, int32_t *params_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 91, 4 * 8, 2 * 8 + yagl_transport_array_size(params, params_maxcount, sizeof(GLint)));
    yagl_transport_put_out_GLuint(t, index);
    yagl_transport_put_out_GLenum(t, pname);
    yagl_transport_put_in_array(t, params, params_maxcount, params_count, sizeof(GLint));
    yagl_transport_end(t);
...
/*
 * glLinkProgram wrapper. id = 92
 */
void yagl_host_glLinkProgram(GLuint program, GLint *params, int32_t params_maxcount, int32_t *params_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 92, 3 * 8, 1 * 8 + yagl_transport_array_size(params, params_maxcount, sizeof(GLint)));
    yagl_transport_put_out_GLuint(t, program);
    yagl_transport_put_in_array(t, params, params_maxcount, params_count, sizeof(GLint));
    yagl_transport_end(t);
}
...
/*
 * glUniform1i wrapper. id = 95
 */
void yagl_host_glUniform1i(GLboolean tl, uint32_t location, GLint x)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 95, 3 * 8, 3 * 8);
    yagl_transport_put_out_GLboolean(t, tl);
    yagl_transport_put_out_uint32_t(t, location);
    yagl_transport_put_out_GLint(t, x);
    yagl_transport_end(t);
...
/*
 * glUniform2i wrapper. id = 99
 */
void yagl_host_glUniform2i(GLboolean tl, uint32_t location, GLint x, GLint y)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 99, 4 * 8, 4 * 8);
    yagl_transport_put_out_GLboolean(t, tl);
    yagl_transport_put_out_uint32_t(t, location);
    yagl_transport_put_out_GLint(t, x);
    yagl_transport_put_out_GLint(t, y);
...
/*
 * glUniformMatrix2fv wrapper. id = 109
 */
...
/*
 * glUniformMatrix3fv wrapper. id = 110
 */
...
/*
 * glUniformMatrix4fv wrapper. id = 111
 */
...
/*
 * glValidateProgram wrapper. id = 113
 */
...
/*
 * glVertexAttrib1f wrapper. id = 114
 */
...
/*
 * glVertexAttrib1fv wrapper. id = 115
 */
...
/*
 * glVertexAttrib2f wrapper. id = 116
 */
void yagl_host_glVertexAttrib2f(GLuint indx, GLfloat x, GLfloat y)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 116, 3 * 8, 3 * 8);
    yagl_transport_put_out_GLuint(t, indx);
    yagl_transport_put_out_GLfloat(t, x);
    yagl_transport_put_out_GLfloat(t, y);
    yagl_transport_end(t);
...
/*
 * glVertexAttrib2fv wrapper. id = 117
 */
...
/*
 * glVertexAttrib3f wrapper. id = 118
 */
...
/*
 * glVertexAttrib3fv wrapper. id = 119
 */
...
/*
 * glVertexAttrib4fv wrapper. id = 121
 */
void yagl_host_glVertexAttrib4fv(GLuint indx, const GLfloat *values, int32_t values_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 121, 3 * 8, 1 * 8 + yagl_transport_array_size(values, values_count, sizeof(GLfloat)));
    yagl_transport_put_out_GLuint(t, indx);
    yagl_transport_put_out_array(t, values, values_count, sizeof(GLfloat));
    yagl_transport_end(t);
}
...
/*
 * glGetActiveUniformsiv wrapper. id = 122
 */
void yagl_host_glGetActiveUniformsiv(GLuint program, const GLuint *uniformIndices, int32_t uniformIndices_count, GLint *params, int32_t params_maxcount, int32_t *params_count)
{
    ...
    yagl_transport_begin(t, yagl_api_id_gles, 122, 5 * 8, 1 * 8 + yagl_transport_array_size(uniformIndices, uniformIndices_count, sizeof(GLuint)) + yagl_transport_array_size(params, params_maxcount, sizeof(GLint)));
    yagl_transport_put_out_GLuint(t, program);
...
/*
 * glGetUniformIndices wrapper. id = 123
 */
void yagl_host_glGetUniformIndices(GLuint program, const GLchar *uniformNames, int32_t uniformNames_count, GLuint *uniformIndices, int32_t uniformIndices_maxcount, int32_t *uniformIndices_count)
{
    ...
    yagl_transport_begin(t, yagl_api_id_gles, 123, 5 * 8, 1 * 8 + yagl_transport_array_size(uniformNames, uniformNames_count, sizeof(GLchar)) + yagl_transport_array_size(uniformIndices, uniformIndices_maxcount, sizeof(GLuint)));
    yagl_transport_put_out_GLuint(t, program);
...
/*
 * glGetUniformBlockIndex wrapper. id = 124
 */
GLuint yagl_host_glGetUniformBlockIndex(GLuint program, const GLchar *uniformBlockName, int32_t uniformBlockName_count)
{
    ...
    yagl_transport_begin(t, yagl_api_id_gles, 124, 5 * 8, 3 * 8 + yagl_transport_array_size(uniformBlockName, uniformBlockName_count, sizeof(GLchar)));
    yagl_transport_put_out_GLuint(t, program);
...
/*
 * glGetActiveUniformBlockName wrapper. id = 126
 */
void yagl_host_glGetActiveUniformBlockName(GLuint program, GLuint uniformBlockIndex, GLchar *uniformBlockName, int32_t uniformBlockName_maxcount, int32_t *uniformBlockName_count)
{
    ...
    yagl_transport_begin(t, yagl_api_id_gles, 126, 4 * 8, 2 * 8 + yagl_transport_array_size(uniformBlockName, uniformBlockName_maxcount, sizeof(GLchar)));
    yagl_transport_put_out_GLuint(t, program);
    yagl_transport_put_out_GLuint(t, uniformBlockIndex);
...
/*
 * glGetActiveUniformBlockiv wrapper. id = 127
 */
void yagl_host_glGetActiveUniformBlockiv(GLuint program, GLuint uniformBlockIndex, GLenum pname, GLint *params, int32_t params_maxcount, int32_t *params_count)
{
    ...
    yagl_transport_begin(t, yagl_api_id_gles, 127, 5 * 8, 3 * 8 + yagl_transport_array_size(params, params_maxcount, sizeof(GLint)));
    yagl_transport_put_out_GLuint(t, program);
    yagl_transport_put_out_GLuint(t, uniformBlockIndex);
    yagl_transport_put_out_GLenum(t, pname);
    yagl_transport_put_in_array(t, params, params_maxcount, params_count, sizeof(GLint));
...
/*
 * glGetIntegerv wrapper. id = 128
 */
void yagl_host_glGetIntegerv(GLenum pname, GLint *params, int32_t params_maxcount, int32_t *params_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 128, 3 * 8, 1 * 8 + yagl_transport_array_size(params, params_maxcount, sizeof(GLint)));
    yagl_transport_put_out_GLenum(t, pname);
    yagl_transport_put_in_array(t, params, params_maxcount, params_count, sizeof(GLint));
    yagl_transport_end(t);
}
...
/*
 * glGetFloatv wrapper. id = 129
 */
void yagl_host_glGetFloatv(GLenum pname, GLfloat *params, int32_t params_maxcount, int32_t *params_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 129, 3 * 8, 1 * 8 + yagl_transport_array_size(params, params_maxcount, sizeof(GLfloat)));
    yagl_transport_put_out_GLenum(t, pname);
    yagl_transport_put_in_array(t, params, params_maxcount, params_count, sizeof(GLfloat));
    yagl_transport_end(t);
}
...
/*
 * glGetString wrapper. id = 130
 */
void yagl_host_glGetString(GLenum name, GLchar *str, int32_t str_maxcount, int32_t *str_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 130, 3 * 8, 1 * 8 + yagl_transport_array_size(str, str_maxcount, sizeof(GLchar)));
...
GLboolean yagl_host_glIsEnabled(GLenum cap)
{
    ...
    yagl_transport_begin(t, yagl_api_id_gles, 131, 3 * 8, 3 * 8);
...
/*
 * glGenTransformFeedbacks wrapper. id = 132
 */
...
/*
 * glBindTransformFeedback wrapper. id = 133
 */
...
/*
 * glBeginTransformFeedback wrapper. id = 134
 */
...
/*
 * glEndTransformFeedback wrapper. id = 135
 */
...
/*
 * glPauseTransformFeedback wrapper. id = 136
 */
...
/*
 * glResumeTransformFeedback wrapper. id = 137
 */
...
/*
 * glTransformFeedbackVaryings wrapper. id = 138
 */
void yagl_host_glTransformFeedbackVaryings(GLuint program, const GLchar *varyings, int32_t varyings_count, GLenum bufferMode)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 138, 4 * 8, 2 * 8 + yagl_transport_array_size(varyings, varyings_count, sizeof(GLchar)));
    yagl_transport_put_out_GLuint(t, program);
...
/*
 * glGetTransformFeedbackVaryings wrapper. id = 139
 */
void yagl_host_glGetTransformFeedbackVaryings(GLuint program, GLsizei *sizes, int32_t sizes_maxcount, int32_t *sizes_count, GLenum *types, int32_t types_maxcount, int32_t *types_count)
{
    ...
    yagl_transport_begin(t, yagl_api_id_gles, 139, 5 * 8, 1 * 8 + yagl_transport_array_size(sizes, sizes_maxcount, sizeof(GLsizei)) + yagl_transport_array_size(types, types_maxcount, sizeof(GLenum)));
    yagl_transport_put_out_GLuint(t, program);
...
/*
 * glGenQueries wrapper. id = 140
 */
void yagl_host_glGenQueries(const GLuint *ids, int32_t ids_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 140, 2 * 8, 0 * 8 + yagl_transport_array_size(ids, ids_count, sizeof(GLuint)));
    yagl_transport_put_out_array(t, ids, ids_count, sizeof(GLuint));
    yagl_transport_end(t);
}

/*
 * glBeginQuery wrapper. id = 141
 */
...
/*
 * glGetQueryObjectuiv wrapper. id = 143
 */
GLboolean yagl_host_glGetQueryObjectuiv(GLuint id, GLuint *result)
{
    ...
    yagl_transport_begin(t, yagl_api_id_gles, 143, 5 * 8, 5 * 8);
    yagl_transport_put_out_GLuint(t, id);
...
/*
 * glGenSamplers wrapper. id = 144
 */
void yagl_host_glGenSamplers(const GLuint *samplers, int32_t samplers_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 144, 2 * 8, 0 * 8 + yagl_transport_array_size(samplers, samplers_count, sizeof(GLuint)));
    yagl_transport_put_out_array(t, samplers, samplers_count, sizeof(GLuint));
    yagl_transport_end(t);
}

/*
 * glBindSampler wrapper. id = 145
 */
...
/*
 * glSamplerParameteri wrapper. id = 146
 */
...
/*
 * glSamplerParameteriv wrapper. id = 147
 */
void yagl_host_glSamplerParameteriv(GLuint sampler, GLenum pname, const GLint *param, int32_t param_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 147, 4 * 8, 2 * 8 + yagl_transport_array_size(param, param_count, sizeof(GLint)));
    yagl_transport_put_out_GLuint(t, sampler);
    yagl_transport_put_out_GLenum(t, pname);
...
/*
 * glSamplerParameterf wrapper. id = 148
 */
void yagl_host_glSamplerParameterf(GLuint sampler, GLenum pname, GLfloat param)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 148, 3 * 8, 3 * 8);
    yagl_transport_put_out_GLuint(t, sampler);
    yagl_transport_put_out_GLenum(t, pname);
    yagl_transport_put_out_GLfloat(t, param);
    yagl_transport_end(t);
...
/*
 * glSamplerParameterfv wrapper. id = 149
 */
void yagl_host_glSamplerParameterfv(GLuint sampler, GLenum pname, const GLfloat *param, int32_t param_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 149, 4 * 8, 2 * 8 + yagl_transport_array_size(param, param_count, sizeof(GLfloat)));
    yagl_transport_put_out_GLuint(t, sampler);
    yagl_transport_put_out_GLenum(t, pname);
...
/*
 * glDeleteObjects wrapper. id = 150
 */
void yagl_host_glDeleteObjects(const GLuint *objects, int32_t objects_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 150, 2 * 8, 0 * 8 + yagl_transport_array_size(objects, objects_count, sizeof(GLuint)));
    yagl_transport_put_out_array(t, objects, objects_count, sizeof(GLuint));
    yagl_transport_end(t);
}

/*
 * glBlendEquation wrapper. id = 151
 */
...
/*
 * glBlendEquationSeparate wrapper. id = 152
 */
void yagl_host_glBlendEquationSeparate(GLenum modeRGB, GLenum modeAlpha)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 152, 2 * 8, 2 * 8);
...
/*
 * glBlendFuncSeparate wrapper. id = 154
 */
...
/*
 * glGenerateMipmap wrapper. id = 169
 */
...
/*
 * glPixelStorei wrapper. id = 172
 */
void yagl_host_glPixelStorei(GLenum pname, GLint param)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 172, 2 * 8, 2 * 8);
    yagl_transport_put_out_GLenum(t, pname);
    yagl_transport_put_out_GLint(t, param);
    yagl_transport_end(t);
}
...
/*
 * glPolygonOffset wrapper. id = 173
 */
...
/*
 * glSampleCoverage wrapper. id = 178
 */
...
/*
 * glStencilFuncSeparate wrapper. id = 180
 */
...
/*
 * glStencilMaskSeparate wrapper. id = 181
 */
...
/*
 * glStencilOpSeparate wrapper. id = 182
 */
...
/*
 * glAlphaFunc wrapper. id = 184
 */
void yagl_host_glAlphaFunc(GLenum func, GLclampf ref)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 184, 2 * 8, 2 * 8);
    yagl_transport_put_out_GLenum(t, func);
...
/*
 * glPointParameterf wrapper. id = 196
 */
...
/*
 * glPointParameterfv wrapper. id = 197
 */
...
/*
 * glFogfv wrapper. id = 199
 */
void yagl_host_glFogfv(GLenum pname, const GLfloat *params, int32_t params_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 199, 3 * 8, 1 * 8 + yagl_transport_array_size(params, params_count, sizeof(GLfloat)));
    yagl_transport_put_out_GLenum(t, pname);
    yagl_transport_put_out_array(t, params, params_count, sizeof(GLfloat));
    yagl_transport_end(t);
}
...
/*
 * glLightf wrapper. id = 201
 */
void yagl_host_glLightf(GLenum light, GLenum pname, GLfloat param)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 201, 3 * 8, 3 * 8);
...
/*
 * glLightfv wrapper. id = 202
 */
void yagl_host_glLightfv(GLenum light, GLenum pname, const GLfloat *params, int32_t params_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 202, 4 * 8, 2 * 8 + yagl_transport_array_size(params, params_count, sizeof(GLfloat)));
    yagl_transport_put_out_GLenum(t, light);
    yagl_transport_put_out_GLenum(t, pname);
    yagl_transport_put_out_array(t, params, params_count, sizeof(GLfloat));
    yagl_transport_end(t);
...
/*
 * glGetLightfv wrapper. id = 203
 */
void yagl_host_glGetLightfv(GLenum light, GLenum pname, GLfloat *params, int32_t params_maxcount, int32_t *params_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 203, 4 * 8, 2 * 8 + yagl_transport_array_size(params, params_maxcount, sizeof(GLfloat)));
    yagl_transport_put_out_GLenum(t, light);
    yagl_transport_put_out_GLenum(t, pname);
    yagl_transport_put_in_array(t, params, params_maxcount, params_count, sizeof(GLfloat));
    yagl_transport_end(t);
...
/*
 * glLightModelf wrapper. id = 204
 */
void yagl_host_glLightModelf(GLenum pname, GLfloat param)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 204, 2 * 8, 2 * 8);
    yagl_transport_put_out_GLenum(t, pname);
    yagl_transport_put_out_GLfloat(t, param);
    yagl_transport_end(t);
}
...
/*
 * glLightModelfv wrapper. id = 205
 */
void yagl_host_glLightModelfv(GLenum pname, const GLfloat *params, int32_t params_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 205, 3 * 8, 1 * 8 + yagl_transport_array_size(params, params_count, sizeof(GLfloat)));
    yagl_transport_put_out_GLenum(t, pname);
    yagl_transport_put_out_array(t, params, params_count, sizeof(GLfloat));
    yagl_transport_end(t);
}
...
/*
 * glMaterialfv wrapper. id = 207
 */
void yagl_host_glMaterialfv(GLenum face, GLenum pname, const GLfloat *params, int32_t params_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 207, 4 * 8, 2 * 8 + yagl_transport_array_size(params, params_count, sizeof(GLfloat)));
    yagl_transport_put_out_GLenum(t, face);
    yagl_transport_put_out_GLenum(t, pname);
    yagl_transport_put_out_array(t, params, params_count, sizeof(GLfloat));
    yagl_transport_end(t);
...
/*
 * glGetMaterialfv wrapper. id = 208
 */
void yagl_host_glGetMaterialfv(GLenum face, GLenum pname, GLfloat *params, int32_t params_maxcount, int32_t *params_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 208, 4 * 8, 2 * 8 + yagl_transport_array_size(params, params_maxcount, sizeof(GLfloat)));
    yagl_transport_put_out_GLenum(t, face);
    yagl_transport_put_out_GLenum(t, pname);
    yagl_transport_put_in_array(t, params, params_maxcount, params_count, sizeof(GLfloat));
    yagl_transport_end(t);
...
/*
 * glShadeModel wrapper. id = 209
 */
void yagl_host_glShadeModel(GLenum mode)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 209, 1 * 8, 1 * 8);
    yagl_transport_put_out_GLenum(t, mode);
    yagl_transport_end(t);
}

/*
 * glLogicOp wrapper. id = 210
 */
...
/*
 * glMultMatrixf wrapper. id = 211
 */
void yagl_host_glMultMatrixf(const GLfloat *m, int32_t m_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 211, 2 * 8, 0 * 8 + yagl_transport_array_size(m, m_count, sizeof(GLfloat)));
    yagl_transport_put_out_array(t, m, m_count, sizeof(GLfloat));
    yagl_transport_end(t);
}

/*
 * glLoadMatrixf wrapper. id = 212
 */
...
/*
 * glClipPlanef wrapper. id = 213
 */
void yagl_host_glClipPlanef(GLenum plane, const GLfloat *equation, int32_t equation_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 213, 3 * 8, 1 * 8 + yagl_transport_array_size(equation, equation_count, sizeof(GLfloat)));
...
/*
 * glGetClipPlanef wrapper. id = 214
 */
void yagl_host_glGetClipPlanef(GLenum pname, GLfloat *eqn, int32_t eqn_maxcount, int32_t *eqn_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 214, 3 * 8, 1 * 8 + yagl_transport_array_size(eqn, eqn_maxcount, sizeof(GLfloat)));
    yagl_transport_put_out_GLenum(t, pname);
...
/*
 * glUpdateOffscreenImageYAGL wrapper. id = 215
 */
void yagl_host_glUpdateOffscreenImageYAGL(GLuint texture, uint32_t width, uint32_t height, uint32_t bpp, const void *pixels, int32_t pixels_count)
{
    ...
    yagl_transport_begin(t, yagl_api_id_gles, 215, 6 * 8, 4 * 8 + yagl_transport_array_size(pixels, pixels_count, 1));
    yagl_transport_put_out_GLuint(t, texture);
...
/*
 * glGenUniformLocationYAGL wrapper. id = 216
 */
void yagl_host_glGenUniformLocationYAGL(uint32_t location, GLuint program, const GLchar *name, int32_t name_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 216, 4 * 8, 2 * 8 + yagl_transport_array_size(name, name_count, sizeof(GLchar)));
    yagl_transport_put_out_uint32_t(t, location);
    yagl_transport_put_out_GLuint(t, program);
    yagl_transport_put_out_array(t, name, name_count, sizeof(GLchar));
    yagl_transport_end(t);
...
/*
 * glDeleteUniformLocationsYAGL wrapper. id = 217
 */
void yagl_host_glDeleteUniformLocationsYAGL(const uint32_t *locations, int32_t locations_count)
{
    struct yagl_transport *t = yagl_get_transport();

    yagl_transport_begin(t, yagl_api_id_gles, 217, 2 * 8, 0 * 8 + yagl_transport_array_size(locations, locations_count, sizeof(uint32_t)));
