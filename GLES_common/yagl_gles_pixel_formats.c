...
YAGL_PIXEL_FORMAT_IMPL_BEGIN(gles, GL_ALPHA, GL_ALPHA, GL_UNSIGNED_BYTE)
    .src_bpp = 1,
...
YAGL_PIXEL_FORMAT_IMPL_BEGIN(gles, GL_ALPHA, GL_ALPHA, GL_FLOAT)
    .src_bpp = 4,
    .dst_internalformat = GL_RGBA,
    .dst_format = GL_BGRA,
    .dst_type = GL_FLOAT,
...
YAGL_PIXEL_FORMAT_IMPL_BEGIN(gles, GL_ALPHA, GL_ALPHA, GL_HALF_FLOAT)
    .src_bpp = 2,
    .dst_internalformat = GL_RGBA,
    .dst_format = GL_BGRA,
...
YAGL_PIXEL_FORMAT_IMPL_BEGIN(gles, GL_ALPHA, GL_ALPHA, GL_HALF_FLOAT_OES)
    .src_bpp = 2,
    .dst_internalformat = GL_RGBA,
    .dst_format = GL_BGRA,
    .dst_type = GL_HALF_FLOAT,
...
YAGL_PIXEL_FORMAT_IMPL_BEGIN(gles, GL_LUMINANCE, GL_LUMINANCE, GL_UNSIGNED_BYTE)
    .src_bpp = 1,
    .dst_internalformat = GL_RGBA,
    .dst_format = GL_BGRA,
    .dst_type = GL_UNSIGNED_BYTE,
...
YAGL_PIXEL_FORMAT_IMPL_BEGIN(gles, GL_LUMINANCE, GL_LUMINANCE, GL_FLOAT)
    .src_bpp = 4,
    .dst_internalformat = GL_RGBA,
    .dst_format = GL_BGRA,
    .dst_type = GL_FLOAT,
...
YAGL_PIXEL_FORMAT_IMPL_BEGIN(gles, GL_LUMINANCE, GL_LUMINANCE, GL_HALF_FLOAT)
    .src_bpp = 2,
    .dst_internalformat = GL_RGBA,
    .dst_format = GL_BGRA,
    .dst_type = GL_HALF_FLOAT,
...
YAGL_PIXEL_FORMAT_IMPL_BEGIN(gles, GL_LUMINANCE, GL_LUMINANCE, GL_HALF_FLOAT_OES)
    .src_bpp = 2,
    .dst_internalformat = GL_RGBA,
    .dst_format = GL_BGRA,
    .dst_type = GL_HALF_FLOAT,
...
YAGL_PIXEL_FORMAT_IMPL_BEGIN(gles, GL_LUMINANCE_ALPHA, GL_LUMINANCE_ALPHA, GL_UNSIGNED_BYTE)
    .src_bpp = 2,
    .dst_internalformat = GL_RGBA,
    .dst_format = GL_BGRA,
    .dst_type = GL_UNSIGNED_BYTE,
...
YAGL_PIXEL_FORMAT_IMPL_BEGIN(gles, GL_LUMINANCE_ALPHA, GL_LUMINANCE_ALPHA, GL_FLOAT)
    .src_bpp = 8,
    .dst_internalformat = GL_RGBA,
    .dst_format = GL_BGRA,
    .dst_type = GL_FLOAT,
...
YAGL_PIXEL_FORMAT_IMPL_BEGIN(gles, GL_LUMINANCE_ALPHA, GL_LUMINANCE_ALPHA, GL_HALF_FLOAT)
    .src_bpp = 4,
    .dst_internalformat = GL_RGBA,
    .dst_format = GL_BGRA,
    .dst_type = GL_HALF_FLOAT,
...
YAGL_PIXEL_FORMAT_IMPL_BEGIN(gles, GL_LUMINANCE_ALPHA, GL_LUMINANCE_ALPHA, GL_HALF_FLOAT_OES)
    .src_bpp = 4,
    .dst_internalformat = GL_RGBA,
    .dst_format = GL_BGRA,
    .dst_type = GL_HALF_FLOAT,
