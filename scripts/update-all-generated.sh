...
./gen-yagl-calls.sh ../EGL/yagl_egl_calls.in yagl_api_id_egl \
    YAGL_HOST_EGL_CALLS EGL/egl.h yagl_host_egl_calls.h,yagl_marshal_egl.h ../EGL/yagl_host_egl_calls \
    QEMU_YAGL_EGL_CALLS yagl_egl_api yagl_egl_calls.h,yagl_host_egl_calls.h,yagl_marshal_egl.h,yagl_thread.h,yagl_process.h yagl_egl_calls
